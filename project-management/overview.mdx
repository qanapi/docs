...
The [Data Proxies](/api/data-proxies/overview) tab provides information about your project's data proxy endpoints, which are used for encrypting and decrypting data.
